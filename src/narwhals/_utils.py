...
class Implementation(NoAutoEnum):
    ...
    def is_bodo(self) -> bool:  # pragma: no cover
        """Return whether implementation is Bodo.

        Examples:
            >>> import narwhals as nw
            >>> nw.Implementation.BODO.is_bodo()
            True
        """
        return self is Implementation.BODO

    def is_pandas_like(self) -> bool:
        """Return whether implementation is pandas, Modin, cuDF, or Bodo.
        ...
        Examples:
            ...
            True
        """
        return self in {Implementation.PANDAS, Implementation.MODIN, Implementation.CUDF, Implementation.BODO}
