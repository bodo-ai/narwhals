...
NativeBodo: TypeAlias = "_BodoDataFrame | _BodoSeries"
NativeCuDF: TypeAlias = "_CuDFDataFrame | _CuDFSeries"
NativePandasLikeSeries: TypeAlias = "pd.Series[Any] | _CuDFSeries | _ModinSeries | _BodoSeries"
NativePandasLikeDataFrame: TypeAlias = "pd.DataFrame | _CuDFDataFrame | _ModinDataFrame | _BodoDataFrame"
...
def is_native_bodo(obj: Any) -> TypeIs[NativeBodo]:  # pragma: no cover
...
def is_native_pandas_like(obj: Any) -> TypeIs[NativePandasLike]:
    return is_native_pandas(obj) or is_native_cudf(obj) or is_native_modin(obj) or is_native_bodo(obj)
